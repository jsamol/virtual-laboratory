...
public class AdvancedMobileRoboticPlatform {
  ...
  public interface Iface extends MobileRoboticPlatform.Iface {
    ...
    public java.util.List<java.lang.String> doSequenceOfMovements(java.util.List<OrderStruct> orders) throws pl.edu.agh.sr.rpc.laboratory.InvalidOperationException, org.apache.thrift.TException;

  }

  public interface AsyncIface extends MobileRoboticPlatform .AsyncIface {

    public void doSequenceOfMovements(java.util.List<OrderStruct> orders, org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.lang.String>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends MobileRoboticPlatform.Client implements Iface {
    ...
    public java.util.List<java.lang.String> recv_doSequenceOfMovements() throws pl.edu.agh.sr.rpc.laboratory.InvalidOperationException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends MobileRoboticPlatform.AsyncClient implements AsyncIface {
    ...
    public static class doSequenceOfMovements_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<java.lang.String>> {
      private java.util.List<OrderStruct> orders;
      public doSequenceOfMovements_call(java.util.List<OrderStruct> orders, org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.lang.String>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public java.util.List<java.lang.String> getResult() throws pl.edu.agh.sr.rpc.laboratory.InvalidOperationException, org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends MobileRoboticPlatform.AsyncProcessor<I> {
    ...
    public static class doSequenceOfMovements<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, doSequenceOfMovements_args, java.util.List<java.lang.String>> {
      public doSequenceOfMovements() {
        super("doSequenceOfMovements");
      }
      ...
      public void start(I iface, doSequenceOfMovements_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<java.lang.String>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class doSequenceOfMovements_result implements org.apache.thrift.TBase<doSequenceOfMovements_result, doSequenceOfMovements_result._Fields>, java.io.Serializable, Cloneable, Comparable<doSequenceOfMovements_result>   {
    ...
    public doSequenceOfMovements_result setSuccess(java.util.List<java.lang.String> success) {
      this.success = success;
      return this;
    }
