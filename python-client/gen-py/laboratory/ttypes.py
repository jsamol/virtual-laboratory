...
class DeviceInUseException(TException):
    """
    Attributes:
     - alert
    """
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'alert', 'UTF8', None, ),  # 1
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.alert = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('DeviceInUseException')
        if self.alert is not None:
            oprot.writeFieldBegin('alert', TType.STRING, 1)
            oprot.writeString(self.alert.encode('utf-8') if sys.version_info[0] == 2 else self.alert)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
